...
const PORTFOLIO_ITEMS = [
  {
    id: 1,
    src: "assets/portfolio/firepit-lounge-night.jpg",
    title: "Вечерняя зона отдыха с переносным очагом",
    description: "Кресла адирондак вокруг компактного очага, гирлянда над двориком и галечная отсыпка — уютное место для тёплых вечеров всей семьёй.",
    category: "Благоустройство территории",
    location: "Загородный участок, Вологодская область",
    caseNum: "CASE 001",
    year: "2025",
  },
  {
    ...
    caseNum: "CASE 002",
    year: "2024",
    // Доп. фото этого же объекта — видно только в лайтбоксе, сразу после основного
    extra: {
  ...
  {
    id: 3,
    src: "assets/portfolio/avtopoliv-lawn.jpg",
    title: "Автоматический полив газона",
    description: "Выдвижные спринклеры равномерно поливают газон по расписанию — трава остаётся сочной и зелёной всё лето.",
    category: "Автополив",
    location: "Загородный участок, Ивановская область",
    caseNum: "CASE 003",
    year: "2025",
  },
  {
  ...
  {
    id: 5,
    src: "assets/portfolio/dizayn-plan.jpg",
    title: "Пример разбивочного плана участка",
    description: "Зонирование, расположение дома, построек и мощения, дендроплан с посадками — показываем концепцию и настроение проекта ещё до старта работ.",
    category: "Ландшафтный дизайн",
    location: "Пример проекта",
    caseNum: "CASE 005",
    year: "2025",
  },
  {
    id: 6,
    src: "assets/portfolio/osveschenie-path.jpg",
    title: "Подсветка дорожки из бетонных плит",
    description: "Грунтовые светильники вдоль дорожки мягко подсвечивают путь через сад широкой полосой света — не слепят и подчёркивают фактуру плит и гравийной отсыпки.",
    category: "Ландшафтное освещение",
    location: "Загородный участок, Владимирская область",
    caseNum: "CASE 006",
    year: "2025",
  },
  {
    id: 7,
    src: "assets/portfolio/case-house-lawn.jpg",
    title: "Загородный дом в вечерней подсветке",
    description: "Тёплый свет из окон, подсветка ступеней и опор террасы, дорожка из плит с грунтовыми светильниками вдоль плодовых деревьев — вечерний фасад и двор смотрятся единым ансамблем.",
    category: "Ландшафтное освещение",
    ...
    // Доп. фото этого же объекта — видно только в лайтбоксе, сразу после основного
    extra: {
      src: "assets/portfolio/case-patio-firepit.jpg",
      title: "Зона отдыха с очагом рядом с детской площадкой",
      description: "Крытая зона с очагом, гирляндой и мягкой мебелью соседствует с детской площадкой — вечернее освещение объединяет обе зоны отдыха для всей семьи.",
      caseNum: "CASE 007+",
    },
  },
  {
    id: 8,
    src: "assets/portfolio/osveschenie-border.jpg",
    title: "Подсветка клумбы вдоль забора",
    description: "Точечные светильники среди хвойных посадок и клумбы очерчивают линию бордюра и создают уютный вечерний свет вдоль всего участка.",
    category: "Ландшафтное освещение",
  ...
  {
    id: 9,
    src: "assets/portfolio/avtopoliv-garden.jpg",
    title: "Простой и бюджетный автополив на даче",
    description: "Линия автополива подаёт воду прямо к грядкам и клумбам — экономит воду и держит растения в тонусе без ручного полива.",
    category: "Автополив",
    location: "Приусадебный участок, Нижегородская область",
    caseNum: "CASE 009",
    year: "2025",
  },
  {
    id: 10,
    src: "assets/portfolio/dizayn-firepit-2.jpg",
    title: "Зона отдыха с перголой и подвесными креслами",
    description: "Деревянная пергола, гамак и подвесные кресла вокруг очага — просторное место для отдыха всей семьёй в любое время суток.",
    category: "Ландшафтный дизайн",
    location: "Загородный дом, Ярославская область",
    caseNum: "CASE 010",
    year: "2025",
  },
  {
    id: 11,
    src: "assets/portfolio/dizayn-firepit-3.jpg",
    title: "Угловая скамья с кострищем",
    description: "Встроенная деревянная скамья по периметру и открытый очаг — камерное место для отдыха на заднем дворе.",
    category: "Благоустройство территории",
    location: "Загородный участок, Костромская область",
    caseNum: "CASE 011",
    year: "2025",
  },
  {
    id: 12,
    src: "assets/portfolio/avtopoliv-scheme.jpg",
    title: "Пример схемы автополива",
    description: "Перед монтажом составляем подробную схему участка: зоны полива, тип дождевателей и капельных линий, расположение контроллера — чтобы вы видели весь проект целиком.",
    category: "Автополив",
    location: "Пример проекта",
    caseNum: "CASE 012",
    year: "2025",
  ...
  {
    id: 14,
    src: "assets/portfolio/besedki-closed-lounge.jpg",
    title: "Крытая беседка с плетёной мебелью и подсветкой",
    description: "Беседка закрытого типа с контурной подсветкой крыши, плетёным диваном и шторами — уютное место для вечерних посиделок в любую погоду.",
    category: "Беседки и МАФ",
    location: "Загородный дом, Костромская область",
    caseNum: "CASE 014",
    year: "2025",
  },
  {
    id: 15,
    src: "assets/portfolio/besedki-wood-open.jpg",
    title: "Деревянная беседка открытого типа",
    description: "Каркасная беседка из дерева с рейчатыми стенками и гирляндой по периметру крыши — просторное место для отдыха всей компанией.",
    category: "Беседки и МАФ",
    location: "Загородный участок, Ярославская область",
    caseNum: "CASE 015",
    year: "2025",
  ...
  {
    id: 16,
    src: "assets/portfolio/besedki-kacheli-pergola.jpg",
    title: "Садовые качели на деревянной перголе",
    description: "Плетёные подвесные кресла-качели на перголе с гирляндой — компактная зона отдыха у костра.",
    category: "Беседки и МАФ",
    location: "Загородный участок, Ивановская область",
    caseNum: "CASE 016",
    year: "2025",
  ...
  {
    id: 17,
    src: "assets/portfolio/besedki-kacheli-krovat-photo.jpg",
    title: "Подвесная кровать-качели на веранде",
    description: "Просторная подвесная скамья-кровать на канатах, встроенная в кровлю веранды загородного дома — с видом на двор.",
    category: "Беседки и МАФ",
    location: "Загородный дом, Владимирская область",
    caseNum: "CASE 017",
    year: "2025",
    // Доп. фото этого же объекта — видно только в лайтбоксе, сразу после основного
    extra: {
      src: "assets/portfolio/besedki-kacheli-krovat-chertezh.jpg",
      title: "Чертёж каркаса подвесной кровати-качели",
      description: "Точный инженерный чертёж каркаса перед раскроем материала — узлы креплений и размеры рассчитаны заранее.",
      caseNum: "CASE 017+",
    },
  },
  {
    id: 18,
    src: "assets/portfolio/besedki-divan-kacheli-pergola.jpg",
    title: "Подвесной диван-качели под перголой",
    description: "Мягкий диван-качели на канатных подвесах под перголой с поликарбонатной крышей — уютное место для отдыха в тени.",
    category: "Беседки и МАФ",
    location: "Загородный участок, Тверская область",
    caseNum: "CASE 018",
    year: "2025",
  },
  {
    id: 19,
    src: "assets/portfolio/besedki-metal-gazebo-lattice.jpg",
    title: "Металлическая беседка с плетёными стенками",
    description: "Каркасная беседка из металла с декоративными плетёными стенками, встроенной угловой скамьёй и обеденным столом.",
    category: "Беседки и МАФ",
    location: "Загородный участок, Нижегородская область",
    caseNum: "CASE 019",
    year: "2025",
  },
];
...
// Не совпадает 1:1 с PORTFOLIO_ITEMS: у кейсов с полем `extra` сразу после
// основного фото вставлено доп. фото, которое не выводится отдельной
// карточкой на странице — его видно только при пролистывании лайтбокса.
const LIGHTBOX_ITEMS = PORTFOLIO_ITEMS.flatMap((item) =>
...
// Считаем накопительно: каждый кейс с `extra` сдвигает все последующие на 1.
const CASE_TO_LIGHTBOX_INDEX = (() => {
  let offset = 0;
  return PORTFOLIO_ITEMS.map((item) => {
    const index = offset;
    offset += item.extra ? 2 : 1;
    return index;
  });
})();
...
const PRICING_DATA = [
  ...
  {
    id: "avtopoliv",
    sectionLabel: "Автополив",
    note: "Расценки указаны за работу. Оборудование (насос, гидроаккумулятор, трубы ПНД, клапаны, спринклеры Hunter, контроллер) рассчитывается отдельно по проекту. Точный объём и итоговая смета формируются после выезда и замера на объект. Консервация системы на зиму в первый сезон входит в договор.",
    groups: [
      {
        title: "Земляные работы",
        rows: [
          { name: "Разметка участка, трассировка зон полива",                     unit: "услуга", price: 3000 },
          { name: "Копка траншей вручную (глубина 30–35 см) с отсевом корней",     unit: "м.п.",   price: 450  },
          { name: "Устройство песчаной подушки (10 см)",                          unit: "м.п.",   price: 100  },
          { name: "Обратная засыпка с послойным уплотнением",                     unit: "м.п.",   price: 200  },
          { name: "Восстановление газона / дёрна (финиш)",                        unit: "м²",     price: 200  },
        ],
      },
      {
        title: "Насосный узел (скважина)",
        rows: [
          { name: "Обвязка скважины, монтаж оголовка",                            unit: "шт.",    price: 3500 },
          { name: "Спуск насоса на тросе, фиксация",                             unit: "шт.",    price: 1500 },
          { name: "Сборка автоматики (реле давления + гидроаккумулятор)",         unit: "узел",   price: 4000 },
          { name: "Пусконаладка, настройка давления",                            unit: "услуга", price: 2000 },
        ],
      },
      {
        title: "Монтаж гидравлики",
        rows: [
          { name: "Сборка коллекторной гребёнки (до 3 клапанов)",                 unit: "узел",   price: 4500 },
          { name: "Установка электромагнитных клапанов",                         unit: "шт.",    price: 800  },
          { name: "Прокладка труб ПНД по траншеям, соединение фитингами",         unit: "м.п.",   price: 250  },
          { name: "Опрессовка системы, проверка герметичности",                  unit: "контур", price: 1000 },
        ],
      },
      {
        title: "Спринклеры и капельный полив",
        rows: [
          { name: "Установка спринклера с гибким коленом",                        unit: "шт.",    price: 700  },
          { name: "Юстировка спринклера (настройка радиуса и сектора)",           unit: "шт.",    price: 250  },
          { name: "Раскладка капельной трубки с фиксацией",                       unit: "м.п.",   price: 80   },
          { name: "Врезка стартовых коннекторов и кранов",                        unit: "шт.",    price: 180  },
        ],
      },
      {
        title: "Автоматика и электрика",
        rows: [
          { name: "Прокладка слаботочного кабеля к клапанам",                     unit: "м.п.",   price: 70   },
          { name: "Установка контроллера, подключение, прошивка",                 unit: "шт.",    price: 3500 },
          { name: "Монтаж датчика дождя",                                         unit: "шт.",    price: 1500 },
        ],
      },
      {
        title: "Сезонное обслуживание",
        rows: [
          { name: "Консервация системы на зиму (продувка компрессором)",          unit: "услуга", price: "В договоре" },
        ],
      },
    ],
  },
