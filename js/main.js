    ...
    groups: [
      {
        ...
        rows: [
          { name: "Выемка грунта вручную (при глубине менее 1 м)",       unit: "м³",   price: 2250 },
          { name: "Выемка грунта механизированным способом",            unit: "м³",   price: 600  },
          { name: "Обратная засыпка грунта вручную",                    unit: "м³",   price: 1400 },
          { name: "Планировка участка вручную",                         unit: "м²",   price: 530  },
          { name: "Планировка участка механизированным способом",       unit: "м²",   price: 250  },
          { name: "Снятие дерна (5 см)",                                unit: "м²",   price: 250  },
          { name: "Бурение ям под столбы",                              unit: "м.п.", price: 750  },
          { name: "Перемещение грунта",                                 unit: "м³",   price: 600  },
          { name: "Подготовка основания из песка",                      unit: "м³",   price: 1400 },
          { name: "Подготовка основания из щебня",                      unit: "м³",   price: 1450 },
          { name: "Укладка геотекстиля",                               unit: "м²",   price: 70   },
      ...
      },
      {
        ...
        rows: [
          ...
          { name: "Устройство поверхностного дренажа (глуб. до 1 м)",    unit: "м.п.", price: 2000  },
          { name: "Устройство глубинного дренажа (глуб. до 2 м)",        unit: "м.п.", price: 4300  },
      ...
      {
        title: "Садовые работы и озеленение",
        rows: [
          ...
          { name: "Валка дерева (диаметр ствола до 30 см)",                            unit: "ед.",   price: 5000  },
          { name: "Валка дерева (диаметр ствола 30–50 см)",                            unit: "ед.",   price: 9000  },
          { name: "Корчевание пня вручную (диаметр до 30 см)",                         unit: "ед.",   price: 2500  },
          { name: "Измельчение порубочных остатков в щепу",                            unit: "м³",    price: 2000  },
          { name: "Санитарная обрезка крупного дерева (до 15 м) с погрузкой",          unit: "ед.",   price: 7000  },
          { name: "Омолаживающая обрезка кустарника (до 2 м)",                         unit: "ед.",   price: 1300  },
          { name: "Пересадка взрослого кустарника с комом земли (до 1,5 м)",           unit: "ед.",   price: 4500  },
          { name: "Пересадка дерева (до 3 м, ком 0,8×0,8 м)",                          unit: "ед.",   price: 12000 },
          { name: "Вывоз порубочных остатков и пней (КамАЗ 20 м³)",                    unit: "рейс",  price: 14000 },
          { name: "Ручная копка ямы для крупномера (100×100×80 см)",                   unit: "ед.",   price: 2000  },
          { name: "Ручная копка ямы для кустарника (50×50×50 см)",                     unit: "ед.",   price: 700   },
          { name: "Ручная копка траншеи для живой изгороди (40×40 см)",                unit: "п.м.",  price: 600   },
          ...
          { name: "Посадка кустарника с открытой корневой системой",                  unit: "ед.",   price: 450   },
          { name: "Посадка живой изгороди (2 растения/п.м, 40–60 см)",                 unit: "п.м.",  price: 900   },
          { name: "Посадка вьющихся растений у опоры (контейнер 3–5 л)",               unit: "ед.",   price: 500   },
          { name: "Установка подпорных кольев (2 шт) и фиксация ствола",               unit: "ед.",   price: 800   },
          { name: "Мульчирование приствольного круга корой/щепой (5–7 см)",            unit: "ед.",   price: 300   },
          { name: "Полив при посадке (ведро 10 л)",                                    unit: "ед.",   price: 70    },
