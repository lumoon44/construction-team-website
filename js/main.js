...
const PORTFOLIO_ITEMS = [
  ...
  },
  {
    ...
    title: "Ландшафтный дизайн участка с прудами",
    description: "Комплексное благоустройство загородного участка: два декоративных пруда, каменные дорожки, газон и многоуровневые посадки хвойников. Точечные грунтовые светильники вдоль тропинок мягко подсвечивают маршрут в тёмное время суток.",
...
function initPromoBadge() {
  ...
  const target = new Date(2026, 6, 31, 23, 59, 59); // 31 июля, конец месяца
