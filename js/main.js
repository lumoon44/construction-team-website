...
// Не совпадает 1:1 с PORTFOLIO_ITEMS: сразу после первого кейса
...
// (сдвиг на 1 после первого кейса — из-за вставленного доп. фото)
const CASE_TO_LIGHTBOX_INDEX = PORTFOLIO_ITEMS.map((_, i) => (i === 0 ? 0 : i + 1));
