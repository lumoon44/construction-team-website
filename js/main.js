...
const PORTFOLIO_ITEMS = [
  {
    id: 1,
    src: "assets/portfolio/dizayn-firepit-1.jpg",
    title: "Круглая зона отдыха с кострищем",
    description: "Каменная отсыпка и деревянные шезлонги вокруг очага — компактное место для вечерних посиделок прямо на газоне.",
